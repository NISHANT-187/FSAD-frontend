        ...
        <table className="student-table">
          ...
          <tbody>
            {filteredStudents.map(student => {
              const achievementCount = achievementList.filter(a => (a.studentId?._id || a.studentId) === student._id).length;
              const participationCount = participationList.filter(p => (p.studentId?._id || p.studentId) === student._id).length;
